...
class DataBatcher(keras.utils.Sequence):
    ...
    def __init__(self, batch_size=150, type=0, shuffle=True):
        ...
        if type == 0:
            self.csv_file_path = os.path.join(pp.gaze_capture_dataset_folder_path, 'train.csv')
        elif type == 1:
            self.csv_file_path = os.path.join(pp.gaze_capture_dataset_folder_path, 'test.csv')
        else:
            self.csv_file_path = os.path.join(pp.gaze_capture_dataset_folder_path, 'validation.csv')
